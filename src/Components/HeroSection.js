  ...
  return (
    <div className="section hero">
     <div className="col typography">
        ...
        <p className="info">Yummy Cha was founded in 2021. We proudly to bring you the best F&B services that guaranteed in quality with a reasonable and affordable prices. So start exploring now  </p>
